...
function Header({ placeholder}) {
  ...
  return (
    <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
      ...
      <input value={searchInput} onChange={(e) => setSearchInput(e.target.value)} type="text"  placeholder={placeholder || 'Start Your Search'} className='pl-5 bg-transparent outline-none flex-grow text-gray-600 placeholder-gray'/>
